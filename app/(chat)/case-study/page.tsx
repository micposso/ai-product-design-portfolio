          ...
          <div className="flex min-h-0 flex-col gap-4">
            <div className="flex w-full items-center justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <Link
                  href="/insights"
                  className="editorial-card editorial-sans inline-flex rounded-full border px-4 py-2 text-xs font-semibold uppercase tracking-[0.16em]"
                >
                  Insights
                </Link>
                <Link
                      ...
                      >
                        <div className="grid gap-4 sm:grid-cols-[180px_minmax(0,1fr)] sm:items-center">
                          ...
                          <div>
                            ...
                            <h2 className="mt-4 text-2xl font-bold text-[var(--editorial-text)]">
                              {caseStudy.title}
                            </h2>
